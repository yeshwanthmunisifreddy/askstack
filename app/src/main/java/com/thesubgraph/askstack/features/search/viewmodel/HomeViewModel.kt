...
class HomeViewModel @Inject constructor(
    ...
    private val _homeMode: MutableStateFlow<HomeMode> = MutableStateFlow(HomeMode.SEARCH)
    val homeMode by lazy { _homeMode.asStateFlow() }
    ...
    fun toggleHomeMode() {
        _homeMode.value = when (_homeMode.value) {
            HomeMode.SEARCH -> HomeMode.AI_MODE
            HomeMode.AI_MODE -> HomeMode.SEARCH
        }
    }
